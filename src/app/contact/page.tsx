    ...
    <div className="mx-auto max-w-6xl px-6 md:px-8 py-16 md:py-28">
      <div className="grid md:grid-cols-[1.2fr_1fr] gap-16 md:gap-24 items-start">
        <div>
          ...
          <div className="mt-10 space-y-8 text-stone-text leading-[1.75] text-[1.05rem] md:text-lg">
            <p>
            ...
            <address className="not-italic space-y-3 text-sm md:text-base">
              <div>
                <span className="block text-[0.65rem] font-mono uppercase tracking-[0.15em] text-stone-muted mb-0.5">Email</span>
              ...
              <div>
                <span className="block text-[0.65rem] font-mono uppercase tracking-[0.15em] text-stone-muted mb-0.5">Phone</span>
                <span className="text-stone-muted">+234 800 000 0000 (placeholder)</span>
              </div>
              <div>
                <span className="block text-[0.65rem] font-mono uppercase tracking-[0.15em] text-stone-muted mb-0.5">Location</span>
        ...
        {/* WhatsApp card */}
        <div className="bg-navy-deep p-8 md:p-10 shadow-[0_20px_60px_rgba(10,22,40,0.2)] relative overflow-hidden">
          <div className="absolute top-0 right-0 w-[200px] h-[200px] bg-brand/5 -translate-y-1/2 translate-x-1/3" aria-hidden="true" />
          <h2 className="font-display text-2xl md:text-[1.75rem] font-normal text-white tracking-tight relative z-10 leading-snug">
            Quick WhatsApp Chat
          </h2>
          <p className="mt-4 text-sm text-white/50 leading-relaxed relative z-10">
            Send a message directly. We respond within minutes during business hours.
          </p>
          <div className="mt-7 relative z-10">
            <WhatsAppButton />
          </div>
          <p className="mt-5 text-[11px] text-white/25 font-mono relative z-10">
